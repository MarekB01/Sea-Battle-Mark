...
public class Displayer {
    ...
    private final HashMap<Integer, String> mapSymbols = new HashMap<>(){{
        put(0, " ");  // пуста клітинка
        put(1, Color.setColor("■", Color.blue));  // корабель
        put(2, Color.setColor("□", Color.yellow)); // підбитий корабель
        put(3, Color.setColor("X", Color.red)); // знищений корабель
